      ...
      <div className="faculty-dashboard-container">
        ...
        <header className="dashboard-header">
          <div className="header-info">
            ...
            <div>
              ...
              <p>
                Manage your classroom communications and deadlines effortlessly.
              </p>
            </div>
          </div>
        </header>
        ...
        <div className="faculty-stats-grid">
          <div className="f-stat-card">
            <div className="f-stat-icon ann-icon">
              <Megaphone size={24} />
            </div>
          ...
          <div className="f-stat-card">
            <div className="f-stat-icon rem-icon">
              <BellPlus size={24} />
            </div>
            <div className="f-stat-content">
              <h3>My Reminders</h3>
          ...
          <div className="f-stat-card wide-stat">
            <div className="f-stat-icon next-icon">
              <Calendar size={24} />
            </div>
            <div className="f-stat-content">
